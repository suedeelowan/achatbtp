    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="fbv_rest_api_key"
                        class="regular-text <?php echo ( strlen( $apiKey ) === 0 ) ? 'hidden' : ''; ?>"
                        value="<?php esc_attr_e( $apiKey ); ?>" onclick="this.select()" />
                    <button type="button" class="button button-primary fbv_generate_api_key_now njt-button-loading">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="button njt_fbv_clear_all_data njt-button-loading">
                        <?php esc_html_e( 'Clear', 'filebird' ); ?>
                    </button>
                    <p class="description">
