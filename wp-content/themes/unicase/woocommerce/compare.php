            ...
            <tr>
                ...
                <?php foreach( $products as $i => $product ) : ?>
                    ...
                    <?php
                        ...
                        $remove_product_url = esc_url_raw( add_query_arg( $remove_product_url_args, unicase_get_compare_page_url() ) );
                    ?>
                    <td class="text-center">
                        <a href="<?php echo esc_url( $remove_product_url ); ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>" class="remove-icon" title="<?php echo esc_attr( esc_html__( 'Remove', 'unicase' ) ); ?>"><i class="fa fa-times"></i></a>
                    </td>
                <?php endforeach ?>
            </tr>
