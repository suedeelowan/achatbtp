...
function redux_toggle_handheld_header( $enable ) {
	global $unicase_options;

	if( isset( $unicase_options['is_handheld_header'] ) ) {
		if( $unicase_options['is_handheld_header'] == '1' ) {
			$enable = TRUE;
		} else {
			$enable = FALSE;
		}
...
function redux_toggle_handheld_footer( $enable ) {
	global $unicase_options;

	if( isset( $unicase_options['is_handheld_footer'] ) ) {
		if( $unicase_options['is_handheld_footer'] == '1' ) {
			$enable = TRUE;
		} else {
			$enable = FALSE;
		}
...
function redux_apply_product_single_layout( $args ) {
	global $unicase_options;

	if( !empty( $unicase_options['single_product_layout'] ) ) {

		if( $unicase_options['single_product_layout'] == 'full-width' ) {
		...
		} elseif ( $unicase_options['single_product_layout'] == 'left-sidebar' ) {
