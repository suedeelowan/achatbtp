			...
			$sections = array(
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'title' => esc_html__('Handheld Header', 'unicase'),
                            'subtitle' => esc_html__('Enable / Disable the Handheld Header.', 'unicase'),
                            'id' => 'is_handheld_header',
                            'on' => esc_html__('Enabled', 'unicase'),
                            'off' => esc_html__('Disabled', 'unicase'),
                            'type' => 'switch',
                            'default' => 0,
                        ...
                        array(         
                            ...
                            'output'   => array(
                                'color' => '.site-header, .top-bar, .main-navigation, .site-description, ul.menu li.current-menu-item > a, .main-header .top-search-holder .contact-row, .top-cart-row .dropdown-cart .dropdown-trigger-cart .total-price-basket .cart-info .label-name, .top-cart-row .dropdown-cart .dropdown-trigger-cart .total-price-basket .cart-info .cart-count'
                            )
                        ),
                ...
                array(
                    ...
                    'fields'            => array(
                        ...
                        array(
                            'title' => esc_html__('Handheld Footer', 'unicase'),
                            'subtitle' => esc_html__('Enable / Disable the Handheld Footer.', 'unicase'),
                            'id' => 'is_handheld_footer',
                            'on' => esc_html__('Enabled', 'unicase'),
                            'off' => esc_html__('Disabled', 'unicase'),
                            'type' => 'switch',
                            'default' => 0,
				...
				array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            ...
                            'title'             => esc_html__( 'Single Product Layout', 'unicase' ),
                            'type'              => 'select',
                            'options'           => array(
                                'full-width'    => esc_html__( 'Full Width', 'unicase' ),
                                'left-sidebar'  => esc_html__( 'Left Sidebar', 'unicase' ),
